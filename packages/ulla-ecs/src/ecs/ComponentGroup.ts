...
export class ComponentGroup {
  ...
  constructor(
    public options: ComponentGroupOptions,
  ...
  addEntity(entity: IEntity) {
    ...
    if (this.entities.indexOf(entity) === -1) {
      ...
      if (this.options.onAddEntity) {
        this.options.onAddEntity(entity);
      }
    }
  }
  ...
  removeEntity(entity: IEntity) {
    ...
    if (id !== -1) {
      ...
      if (this.options.onRemoveEntity) {
        this.options.onRemoveEntity(entity);
      }
    }
  }
