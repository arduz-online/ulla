...
export class Entity implements IEntity {
   ...
   */
  removeComponent(component: string, triggerRemovedEvent?: boolean): boolean
  removeComponent<T extends object>(component: T, triggerRemovedEvent?: boolean): boolean
  removeComponent(component: ComponentConstructor<any>, triggerRemovedEvent?: boolean): boolean
  removeComponent(component: object | string | Function, triggerRemovedEvent = true): boolean {
    const typeOfComponent = typeof component
