...
const WS = require("../packages/ulla-rpc/test/server/_testWebSocketServer");
...
app.get("/", function(req, res) {
  res.sendFile(resolve(__dirname, "../packages/ulla-rpc/test/index.html"));
});
...
app.use(
  "/test",
  express.static(resolve(__dirname, "../packages/ulla-rpc/test"))
);
  ...
  if (error) {
    ...
    titere
      ...
      .then(result => {
        if (result.coverage) {
          fs.writeFileSync(
            resolve(__dirname, "../packages/ulla-rpc/test/out/out.json"),
